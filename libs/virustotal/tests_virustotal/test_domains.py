...
class DomainsTests(TestCase):
    ...
    def test_get_vt_information_domains_returns_valid_dict_when_given_response_with_valid_keys(self):
        '''
        ...
        path = get_path(__file__, 'resources/vt_domain_response_valid.json')
